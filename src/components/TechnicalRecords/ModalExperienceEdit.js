...
const ModalExperienceEdit = (props) => {
    ...
    >
        <Box sx={style} component="form">
            ...
            <Grid container spacing={2} marginTop={1}>
                <Grid item xs={6}>
                    <TextField id="outlined-basic" variant="standard" label="Category" fullWidth defaultValue={props.skill.type} />
                </Grid>
                <Grid item xs={6}>
                    <TextField id="outlined-basic" label="Location" variant="standard" fullWidth defaultValue={props.skill.location} />
                </Grid>
            </Grid>
