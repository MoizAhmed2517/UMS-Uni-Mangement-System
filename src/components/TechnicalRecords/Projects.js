...
const rows = [
    createData('Uni Management System', 'https://digiskills.pk/Default.aspx', 'The project is responsible for helping uni to manage overall student profile and make learning interactive. The project is responsible for helping uni.', 'React', 'Django'),
                        ...
                        <TableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                            <TableCell align="left">
                                <Stack direction="row">
                                    ...
                                    <IconButton sx={{ color: '#153E52', marginLeft: 'auto', height: 20, width: 20 }} onClick={() => handleOpenModalEdit(row, index, row.descr.length)}>
